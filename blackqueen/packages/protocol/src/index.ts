...
export const ClientActionSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("EMOTE"), roomId: z.string(), playerId: z.string(), actionId: z.string().uuid(), stateVersion: z.number().int().nonnegative(), payload: z.object({ emote: z.enum(["abbe", "jaldi", "mast", "gg", "newpartner", "kya", "waah", "chalo", "oof", "bakwaas"]) }).strict() }),
]);
